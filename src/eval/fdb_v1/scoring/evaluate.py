...
from _openai_client import make_client

# Load environment variables from .env file
load_dotenv()

# For OpenAI API api key (kept for backward compat; make_client() handles routing)
...
def main():
    ...
    if args.task == "backchannel":
        ...
        try:
            ...
            # Some LiteLLM proxies restrict models.list(); not fatal.
            print(f"[warn] client.models.list() failed: {exc}")
